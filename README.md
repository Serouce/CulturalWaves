...
- Прохождение викторин на тему культуры. Вопросы и ответы с фидбэком генерирует ИИ Gemini (на скриншоте светлая тема приложения)
  <p align="center">
    <img src="images/quiz_screen_ph.jpg" alt="Экран викторины" width="200"/>
  </p>
